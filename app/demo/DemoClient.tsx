      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-16">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-4xl font-semibold text-[rgb(var(--foreground))]">
              MoldPredict Console
            </h1>
          </div>
          <div className="relative flex items-center gap-3">
            ...
            <button
              ...
              className={`inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-semibold shadow-sm transition ${
                isDemoMode
                  ? "cursor-not-allowed border-[rgb(var(--border))] bg-[rgb(var(--input))] text-slate-400"
                  : "border-[rgb(var(--border))] bg-[rgb(var(--input))] text-slate-700 hover:border-blue-200 hover:text-blue-700"
              }`}
            >
              Account
            ...
            {isMenuOpen && !isDemoMode ? (
              <div className="absolute right-0 mt-2 w-64 rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-2 text-sm text-slate-700 shadow-xl">
                ...
                <button
                  ...
                  className="mt-2 flex w-full items-center justify-between rounded-xl px-3 py-2 text-left text-sm font-semibold text-slate-700 transition hover:bg-[rgb(var(--input))]"
                >
                  Log out
                  <span className="text-base">?</span>
                </button>
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-6">
            ...
            >
              ...
              <div className="mt-6 rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--input))] p-4">
                <button
                  type="button"
                  ...
                  className={`inline-flex items-center gap-2 rounded-md border px-3 py-2 text-xs font-semibold uppercase tracking-wide ${
                    hasAgreed
                      ...
                      : "border-[rgb(var(--border))] bg-[rgb(var(--input))] text-slate-700"
                  }`}
                >
                  <span
          ...
          <div className="rounded-2xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-6 shadow-sm">
              ...
              {/* Risk Bar (based on anticipatedRunTime vs predictedDays) */}
              {predictedDays && predictedDays > 0 ? (
                <div className="mt-6 relative">
                  ...
                  <div className="relative h-3 rounded-full bg-gradient-to-r from-emerald-400 via-amber-400 to-rose-400">
                    <span
                ...
                <button
                  ...
                  className={`rounded-md border px-4 py-2 text-sm font-semibold ${
                    emailSent
                      ? "border-emerald-200 bg-emerald-50 text-emerald-700"
                      : "border-[rgb(var(--border))] text-slate-700 transition hover:border-blue-200 hover:text-blue-700"
                  }`}
                >
                ...
                {showEmailForm ? (
                  <form
                    ...
                    className="rounded-lg border border-[rgb(var(--border))] bg-[rgb(var(--input))] p-4"
                  >
                    <label
                      htmlFor="reportEmail"
                      className="block text-xs font-semibold uppercase tracking-wide text-slate-500"
                    ...
                    <div className="mt-2 flex flex-col gap-3 sm:flex-row">
                      <input
                        ...
                        className="w-full rounded-md border border-[rgb(var(--border))] bg-[rgb(var(--input))] px-3 py-2 text-sm text-[rgb(var(--foreground))] shadow-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-200"
                      />
                      <button
                        type="submit"
